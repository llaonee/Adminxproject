...
public class BerandaAdmin extends BaseApp
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CardView cvBroadcast = (CardView) findViewById(R.id.cvBrodcast);
        final CardView cvGroup = (CardView) findViewById(R.id.cvGroup);
        final CardView cvManager = (CardView) findViewById(R.id.cvManager);
        final CardView cvUser = (CardView) findViewById(R.id.cvUser);
        cvBroadcast.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        cvGroup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(context, ManageGroup.class);
                startActivity(i);
            }
        });
        ...
        cvUser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(context, ContentUser.class);
                startActivity(i);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // automatically handle clicks on the BerandaAdmin/Up button, so long
